...
public class Demo_Academic_Level : MonoBehaviour {

	List<string> options = new List<string>() { "Please Select an Option", "Freshman", "Sophomore", "Junior", "Senior", "Masters", "PhD"};
	...
	void WriteFile(){
		...
		string appendText = "Academic Level" + " - " + selectedOption + ", " + System.DateTime.Now.ToString() + "\r\n";
